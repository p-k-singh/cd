...
import CompanyKYCForm from "./KYCForm";
import IndexCompanyDetails from "./BasicInfoKyc/BasicInfoIndex";
import TaxIndex from "./TaxInfoKyc/TaxInfoIndex";
import AccountIndex from "./AccountInfoKyc/AccountInfoIndex";
    ...
    <Card>
      ...
      >
        <Typography
          ...
          align="left"
        >
          Company Info KYC <CheckCircleOutlineIcon />
        </Typography>
        <Typography
          fullWidth
          className={classes.title}
      ...
      >
        <Typography
          ...
          align="left"
        >
          Tax Info KYC <CheckCircleOutlineIcon />{" "}
        </Typography>
        <Typography
          fullWidth
          className={classes.title}
      ...
      <Grid
        container
        style={{ backgroundColor: "#66bb6a", marginTop: 30, minHeight: "400%" }}
        justify="space-between"
      >
        <Typography
          fullWidth
