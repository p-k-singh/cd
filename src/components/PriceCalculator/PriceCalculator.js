        ...
        </div>
        {
                   showPrice===true &&
                    ...
                    <Grid>
                        <Button
                        sm={6}
                     style={{float:'right',marginTop:'10px',marginRight:'30px',backgroundColor:'#f9a825'}}
                     variant="contained"
                     //color="primary"
...
const mapStateToProps=state=>{
  ...
  const mapDispatchToProps=dispatch=>{
    return {
        ...
        setChosenProducts:(chosenProducts)=>dispatch(actions.setChosenProducts(chosenProducts))
    };
  }
